    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkSis" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLinkSis">
          <a class="dropdown-item" href="/mengukl/crud/siswa.php">Data Siswa</a>
          <a class="dropdown-item" href="/mengukl/crud/kelas.php">Data Kelas</a>
        </div>
      </li>
      ...
      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkSPP" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <a class="dropdown-item" href="/mengukl/transaction/spp.php">Data SPP</a>
        <a class="dropdown-item" href="/mengukl/transaction/transaksi.php">Transaksi</a>
        <a class="dropdown-item" href="/mengukl/misc/history.php">History Pembayaran</a>
        </div>
      </li>
